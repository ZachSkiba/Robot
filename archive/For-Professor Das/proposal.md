...
### Background
* Software environment is mostly prepared (ROS2, MoveIt, Gazebo, devcontainers, scripts).
...
#### 4. Simulation (if time)
* Export CAD to URDF/Gazebo (or ANSYS), starting with J1–J3.
* **Validate:**
